...
public class BranchingFactor {
	 ...
	 * <tt>depth</tt> was discovered. Note that <tt>depth</tt> must be
	 * nonnegative, and <tt>num_expanded</tt> must be at least <tt>depth</tt>
	 * plus one (otherwise an <tt>IllegalArgumentException</tt> will be thrown).
	 */
