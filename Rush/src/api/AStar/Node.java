...
public class Node {
	...
	/**
	 * The main constructor for constructing a search node. You probably will
	 * never need to use this constructor directly, since ordinarily, new nodes
	 * will be gotten from the <tt>expand</tt> method.
	 *
	 * @param state
	 *            the state that resides at this node
	 * @param depth
